 ...
 * con un sutil glow teal. Se ve bien sobre fondo claro u oscuro.
 */
    ...
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Logo">
      <defs>
        <radialGradient id="logoGlow" cx="50%" cy="38%" r="62%">
          ...
          <stop offset="100%" stopColor="#08100e" />
        </radialGradient>
        <linearGradient id="logoN" x1="20" y1="18" x2="44" y2="46" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#d6faf3" />
        </linearGradient>
      </defs>

      {/* Badge */}
      <circle cx="32" cy="32" r="31" fill="url(#logoGlow)" />
      <circle cx="32" cy="32" r="31" stroke="#2dd4bf" strokeOpacity="0.28" strokeWidth="1.5" />
      ...
      />
      {/* Punto/acento */}
      <circle cx="40.6" cy="22.2" r="2.5" fill="#2dd4bf" />
    </svg>
  );
}
